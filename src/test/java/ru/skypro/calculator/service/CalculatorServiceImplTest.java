...
import ru.skypro.calculator.exception.CalculatorException;
import ru.skypro.calculator.service.serviceImpl.CalculatorServiceImpl;
...
public class CalculatorServiceImplTest {
    ...
    public void shouldThrowExceptionWhenSecondArgumentIsZero(){
        ...
        Assertions.assertThrows(
                CalculatorException.class,()->calculatorService.divide(num1,num2)
        );
    }
}